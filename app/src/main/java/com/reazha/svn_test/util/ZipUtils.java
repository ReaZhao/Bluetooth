...
public class ZipUtils {
	 ...
	 *             IO错误时抛出
	 */
	public static boolean zipFiles(Collection<File> resFiles,
			String zipFilePath, String comment) throws IOException {
	...
	public static boolean zipFile(String resFilePath, String zipFilePath,
			String comment) throws IOException {
		return zipFile(FileUtils.getFileByPath(resFilePath),
				FileUtils.getFileByPath(zipFilePath), comment);
	}
	 ...
	 *             IO错误时抛出
	 */
	private static boolean zipFile(File resFile, String rootPath,
	 ...
	 *             IO错误时抛出
	 */
	public static boolean unzipFiles(Collection<File> zipFiles,
	 ...
	 *             IO错误时抛出
	 */
	public static List<File> unzipFileByKeyword(String zipFilePath,
			String destDirPath, String keyword) throws IOException {
	 ...
	 *             IO错误时抛出
	 */
	public static List<File> unzipFileByKeyword(File zipFile, File destDir,
		...
		while (entries.hasMoreElements()) {
			...
			if (StringUtils.isEmpty(keyword)
					|| FileUtils.getFileName(entryName).toLowerCase()
